...
export const metadata: Metadata = {
  title: "Politique de confidentialité — Badino",
};
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12">
      ...
      <div className="mt-8 space-y-6 text-sm text-zinc-800/80">
        <section>
          <h2 className="font-semibold text-zinc-950">Données collectées</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="font-semibold text-zinc-950">Utilisation des données</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="font-semibold text-zinc-950">Stockage</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="font-semibold text-zinc-950">Vos droits</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="font-semibold text-zinc-950">Cookies</h2>
          <p className="mt-2">
