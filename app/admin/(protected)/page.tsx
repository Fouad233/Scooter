...
export default async function AdminReservationsPage() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-zinc-950">Réservations</h1>

      {liste.length === 0 ? (
        <p className="mt-6 text-zinc-800/60">Aucune réservation pour le moment.</p>
      ) : (
        <div className="mt-6 space-y-4">
          {liste.map((reservation) => (
            <div key={reservation.id} className="rounded-2xl border border-zinc-200 bg-white p-4">
              ...
              <div className="mt-3 text-sm text-zinc-800/80">
